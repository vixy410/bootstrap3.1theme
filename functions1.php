...
function create_post_type_html5()
{
    ...
    register_post_type('html5-blank', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('HTML5 Blank Custom Post', 'ck'), // Rename these to suit
            'singular_name' => __('HTML5 Blank Custom Post', 'ck'),
            'add_new' => __('Add New', 'ck'),
            'add_new_item' => __('Add New HTML5 Blank Custom Post', 'ck'),
            'edit' => __('Edit', 'ck'),
            'edit_item' => __('Edit HTML5 Blank Custom Post', 'ck'),
            'new_item' => __('New HTML5 Blank Custom Post', 'ck'),
            'view' => __('View HTML5 Blank Custom Post', 'ck'),
            'view_item' => __('View HTML5 Blank Custom Post', 'ck'),
            'search_items' => __('Search HTML5 Blank Custom Post', 'ck'),
            'not_found' => __('No HTML5 Blank Custom Posts found', 'ck'),
            'not_found_in_trash' => __('No HTML5 Blank Custom Posts found in Trash', 'ck')
        ),
        'public' => true,
